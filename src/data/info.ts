export const info = {
  ...
  jobDescription: "Mobile Developer · iOS Specialist · 4+ Years of Experience",
  contact: {
    phone: "+52 55 6058 9448",
    email: "contact@roncuevas.com"
  },
  about: `Desarrollador móvil con más de 4 años de experiencia construyendo aplicaciones iOS de alto rendimiento para clientes empresariales como Expedia Group, Grupo Salinas (Elektra), ENGIE y plataformas de salud. Dominio de Swift, SwiftUI, UIKit y GraphQL/Apollo, con historial comprobado entregando funcionalidades para millones de usuarios.

Doble formación en Computación y Medicina, con experiencia práctica en investigación bioinformática. Profesional multilingüe (español, inglés, italiano, ruso) con background en desarrollo freelance full-stack y cloud, lo que me da una perspectiva integral del ciclo de desarrollo de software.
...
Actualmente explorando Kotlin Multiplatform (KMP) y Jetpack Compose para ampliar mi perfil como desarrollador móvil cross-platform.`,
  ...
  languages: [
    ...
    { name: "English", proficiency: "Full Professional (B2/C1)" },
  ...
  experience: [
    ...
    {
      name: "Apex Systems → Expedia Group",
